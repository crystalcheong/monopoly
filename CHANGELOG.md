...
- *(standard_chartered)* Added support for debit
- *(maribank)* Debit statement support
...
- *(standard_chartered)* Integration tests
- *(standard_chartered)* Updated filter
- Tweaked dbs bound + adjusted safety check threshold
...
- Tweaked setup script
- *(maribank-debit)* Updated description parse
...
- *(statement)* Add support for multiline statement date
- *(statement)* Allow custom date string using regex named groups
